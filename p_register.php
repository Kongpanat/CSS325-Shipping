                ...
                <div class="section-content">
                    ...
                    <div class="row">
						...
						<form method="post" name="package-register-form" action="">
                            ...
                            <p>Sending Address:</p>
                            <div class="col-md-12 form-input">
                                <textarea type="text" class="form-control" style="height:12em;" id="sendadd" name="sendadd" placeholder=""><!--text from old detail--></textarea>
                            </div>
							<div class="col-md-6 form-input">
							...
							<p>Package Note:</p>
							<div class="col-md-12 form-input">
                                <textarea type="text" class="form-control" style="height:12em;" id="note" name="note" placeholder=""><!--text from old detail--></textarea>
                            </div><br>
                            ...
                            <div class="col-md-12 form-input">
                                <textarea type="text" class="form-control" style="height:12em;" id="recadd" name="recadd" placeholder=""><!--text from old detail--></textarea>
                            </div>
							<div class="col-md-6 form-input">
