                            ...
                            <form method="post" name="login-form" action="">
								...
								<?php
									...
									if($result=$mysqli->query($q)){
										while($row=$result->fetch_array()){
											echo "<tr>";
											echo "<th style='border: 1px solid black'>".$row[0]."</th>";
											echo "<th style='border: 1px solid black'>".$row[1]."&emsp;".$row[2]."</th>";
											echo "<th style='border: 1px solid black'>".$row[3]."</th>";
											echo "<th style='border: 1px solid black'>".$row[4]."&emsp;".$row[5]."</th>";
											echo "<th style='border: 1px solid black'>".$row[6]."</th>";
											echo "<th style='border: 1px solid black'>".$row[7]."</th>";
											echo "<th style='border: 1px solid black'>".$row[8]."</th>";
											echo "<th style='border: 1px solid black'>".$row[9]."</th>";
											echo "<th style='border: 1px solid black'>".$row[10]."</th>";
										?>
											<th style='border: 1px solid black'><a href='edit_home.php?sendingid=<?=$row[0]?>&pickup=<?=$row[8]?>&delivered=<?=$row[9]?>'>EDIT</a></th>
										<?php
											echo "</tr>";
										}
									}else{
