                        ...
                        <div class="col-md-8 offset-md-2 contact-form-holder mt-4">
                            <form method="post" name="login-form" action="">
								...
								<div class="row">
								 <p>Address:</p>
									<div class="col-md-12 form-input">
										<textarea type="text" class="form-control" style="height:12em;" id="staffadd" name="staffadd" placeholder="">
										</textarea>
									</div>
									<p>Date of Birth:</p>
									<div class="col-md-12 form-input">
                                    ...
                                    <br><div class="col-md-12 form-btn text-center">
...
<?php 
				if(isset($_POST['signup'])) {
					...
					$q="INSERT INTO staff (Branch_ID, Fname, Lname, Staff_Addr, DOB,Email, Password, Phone_no) 
					VALUES ('$_POST[branch]','$_POST[fname]','$_POST[lname]','$_POST[staffadd]','$_POST[DOB]','$_POST[email]','$_POST[password]','$_POST[staffphone]')";
